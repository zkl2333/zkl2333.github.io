...
<template>
	<div
		class="flex flex-col md:flex-row items-center gap-8 md:gap-16 mb-10 md:mb-16 relative z-10 animate-fade-up"
	...
	>
			...
			<div class="relative w-32 h-32 sm:w-40 sm:h-40 md:w-52 md:h-52">
				<div
					...
					:class="
						isMobile
							? 'active:scale-95'
							: 'group-hover:scale-[1.02] group-hover:rotate-2'
					"
				>
					<img
						:src="avatarUrl"
		...
		<div
			class="flex-1 text-center md:text-left flex flex-col items-center md:items-start px-2 md:px-0"
		>
